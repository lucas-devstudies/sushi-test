    ...
    return(
         <section className="flex justify-center items-center h-screen w-screen">
            <form onSubmit={(e)=> {e.preventDefault();signUp();}} className="bg-mauve-950 flex flex-col gap-3 drop-shadow-[0_20px_100px_rgba(185,28,28,0.7)] py-4 px-5 rounded-2xl w-full max-w-100">
                ...
                <label className="w-100 text-start text-xl font-bold text-white font-changa">Nome:</label>
                ...
                <label className="w-100 text-start text-xl font-bold text-white font-changa">Telefone:</label>
                ...
                <a href="/admin/login" className="font-changa text-xl text-center mb-4">Já tem uma conta? <span className="text-white">Faça login</span></a>
            </form>
        </section>
    )
}