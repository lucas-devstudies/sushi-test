    ...
    return(
        <main className="overflow-x-hidden">
            <section className="w-screen h-screen overflow-hidden">
                <video src={videoBg} autoPlay loop muted style={{margin:0, width: '100dvw', height: '100dvh', objectFit: 'cover', zIndex: -1}}/>
                <button 
            ...
            <section className="w-screen">
                <h2 className='text-5xl py-6 font-bold text-white font-protest'>Pratos Principais</h2>
                <div className="flex items-end justify-center mt-5 mb-5">
                    {
                        listFoods.map((food) => (
