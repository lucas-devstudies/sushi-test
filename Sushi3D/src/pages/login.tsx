...
export default function Login() {
    ...
    return(
        <section id="login" className="flex justify-center items-center h-screen">
            <form onSubmit={(e)=> {e.preventDefault();signIn();}} className="bg-mauve-950 flex flex-col gap-3 drop-shadow-[0_20px_100px_rgba(185,28,28,0.7)] py-4 px-5 rounded-2xl">
                ...
                <button className="bg-red-700 px-4 mt-2 py-3 rounded-4xl text-white font-semibold text-xl hover:bg-red-800 active:scale-90" onClick={()=>signIn()}>Entrar</button>
                <a href="/admin/register" className="text-xl text-center mb-4 mt-2">Não tem uma conta? <span className="text-white">Cadastre-se</span></a>
            </form>
        </section>
    )
}